CREATE OR REPLACE FUNCTION public.public_reschedule_appointment(p_token text, p_appointment_id uuid, p_new_start_at timestamp with time zone, p_new_end_at timestamp with time zone)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
